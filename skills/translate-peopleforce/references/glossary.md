...
| **probation period** | periodo de prueba | okres próbny | випробувальний термін | Corrected after a no-glossary arm produced `випробувальний` and the corpus backed it against the cell: 43 hits across 20 articles and 60 across 23 calls, against 7 article hits and zero spoken for `випробний`. The cell had the rarer form. |
